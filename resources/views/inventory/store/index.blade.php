            ...
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mg-b-0">عرض المخازن</h4>
                        <div class="card-toolbar">
                            <button class="btn btn-light">
                                <i class="mdi mdi-plus" style="color: black;"></i>
                                <a href="{{ url('inventory/store/create') }}" style="font: bolder; color:rgb(0, 0, 0);">
                                    إضافة المخازن </a>
                            </button>
                        </div>
                    </div>
                                ...
                                @foreach ($store as $stores)
                                    ...
                                    <tr>
                                        ...
                                        <td data-field="Actions" data-autohide-disabled="false" aria-label="null"
                                            ...
                                            {{-- <form method="POST" action="{{ url('/inventory/store' . '/' . $stores->id) }}"
                                            ...
                                            <a class="modal-effect btn btn-sm btn-danger btn-icon"
                                                data-effect="effect-scale" data-store_id="{{ $stores->id }}"
                                                data-store_name="{{ $stores->store_name }}" data-toggle="modal"
                                                href="#modaldemo8" title="حذف"><i class="la la-trash"></i></a>

                                            <a href="{{ url('/inventory/store/' . $stores->id . '/edit') }}"
                                                class="btn btn-sm btn-success btn-icon ml-2 mr-2" title="Edit details"><i
                                                    class="la la-edit"></i></a>

                                            <a href="{{ url('/inventory/store/' . $stores->id) }}"
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content modal-content-demo">
                    <div class="modal-header">
                        <h6 class="modal-title">حذف المخزن</h6><button aria-label="Close" class="close"
                    ...
                    <form action="{{ route('store.destroy', 'test') }}" method="post">
                        ...
                        <div class="modal-body">
                            ...
                            <input class="form-control" name="store_name" id="store_name" type="text" readonly>
                        </div>
