            ...
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mg-b-0">عرض الدوائر</h4>
                        <div class="card-toolbar">
                            <button class="btn btn-light">
                                <i class="mdi mdi-plus" style="color: black;"></i>
                                <a href="{{ url('inventory/department/create') }}"
                        ...
                        <table id="example">
                            ...
                            <tbody>
                                ...
                                @foreach ($department as $departments)
                                    ...
                                    <tr>
                                        <td> {{ $i }}</td>
                                        <td> {{ $departments->department_num }}</td>
                                        ...
                                        <td data-field="Actions" data-autohide-disabled="false" aria-label="null"
                                            ...
                                            {{-- <form method="POST"
                                                action="{{ url('/inventory/department' . '/' . $departments->id) }}"
                                            ...
                                            <a class="modal-effect btn btn-sm btn-danger btn-icon"
                                                data-effect="effect-scale" data-department_id="{{ $departments->id }}"
                                                data-department_name="{{ $departments->department_name }}" data-toggle="modal"
                                                href="#modaldemo8" title="حذف"><i class="la la-trash"></i></a>

                                            <a href="{{ url('/inventory/department/' . $departments->id . '/edit') }}"
                                                class="btn btn-sm btn-success btn-icon ml-2 mr-2" title="Edit details"><i
                                                    class="la la-edit"></i></a>

                                            <a href="{{ url('/inventory/department/' . $departments->id) }}"
                                                title="View department"><button class="btn btn-sm btn-info btn-icon"> <svg
