            ...
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mg-b-0">عرض العائلات</h4>
                        <div class="card-toolbar">
                            <button class="btn btn-light">
                                <i class="mdi mdi-plus" style="color: black;"></i>
                                <a href="{{ url('inventory/category/create') }}" style="font: bolder; color:rgb(0, 0, 0);">
                                    إضافة العائلات </a>
                            </button>
                        </div>
                    </div>
                                ...
                                @foreach ($category as $categorys)
                                    ...
                                    <tr>
                                        ...
                                        <td data-field="Actions" data-autohide-disabled="false" aria-label="null"
                                            ...
                                            <a class="modal-effect btn btn-sm btn-danger btn-icon" data-effect="effect-scale"
                                                data-category_id="{{ $categorys->id }}"
                                                data-category_name="{{ $categorys->category_name }}" data-toggle="modal"
                                            ...
                                            <a href="{{ url('/inventory/category/' . $categorys->id) }}"
                                                title="View categorys"><button class="btn btn-sm btn-info btn-icon"> <svg
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content modal-content-demo">
                    <div class="modal-header">
                        <h6 class="modal-title">حذف العائلة</h6><button aria-label="Close" class="close"
