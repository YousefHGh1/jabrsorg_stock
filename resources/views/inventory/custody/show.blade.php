            ...
            <div class=" main-content-body-invoice" id="print">
                <div class="card card-invoice">
                    <div class="card-body">
                        ...
                        <div class="row mg-t-20">
                            ...
                            <div class="col-md">
                                ...
                                <p class="invoice-info-row"><span> الدائرة </span>
                                    <span>{{ $custody->department->department_name }}</span>
                                </p>
                                <p class="invoice-info-row"><span> القسم</span>
                                    <span>{{ $custody->sub_department_id }}</span>
                                </p>
                        ...
                        <a href="{{ url('inventory/custody/create') }}" type="button" id="print_Button"
                            class="btn btn-warning font-weight-bolder ml-sm-auto my-1">انشاء عهدة</a>

                            <a href="{{ url('/inventory/custody/' . $custody->id . '/edit') }}"
                                class="btn btn-primary font-weight-bolder ml-sm-auto my-1" title="Edit details">
