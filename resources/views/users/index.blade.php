...
@section('page_title', 'عرض المستخدمين')
            ...
            <div class="card">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mg-b-0">عرض المستخدمين</h4>
                        <div class="card-toolbar">
                            <button class="btn btn-light">
                                <i class="mdi mdi-plus" style="color: black;"></i>
                                <a href="{{ route('users.create') }}" style="font: bolder; color:rgb(0, 0, 0);">
                                    اضافة المستخدمين </a>
                            </button>
                        </div>
                    </div>
