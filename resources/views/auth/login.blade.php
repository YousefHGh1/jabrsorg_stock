    ...
    <div class="container-fluid">
        <div class="row no-gutter">
                            ...
                            <div class="col-md-10 col-lg-10 col-xl-9 mx-auto">
                                <div class="card-sigin">
                                    <div class="mb-5 d-flex"> <a href="{{ url('/' . ($page = 'Home')) }}"><img
                                        ...
                                        <h1 class="main-logo1 ml-1 mr-2 my-auto tx-28">المخازن</h1>
                                    </div>
                                    <div class="card-sigin">
                                                            ...
                                                            <div class="form-check">
                                                                ...
                                                                <label class="form-check-label" style="float: left"
                                                                    ...
                                                                    <a href="{{ route('register') }}"
                                                                        style="text-decoration: none">لا أمتلك حساب !!!</a>
                                                                </label>
                                                            </div>
                                                        </div>
            ...
            <div class="col-md-6 col-lg-6 col-xl-6">
                <img src="{{ URL::asset('assets/img/Spreadsheets-rafiki.png') }}" width="100%" height="100%"
                    alt="logo">
            </div>
